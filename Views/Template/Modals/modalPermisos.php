                      ...
                      <table class="table">
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="checkbox" name="modulos[<?= $i; ?>][r]" <?= $rCheck ?>  data-bootstrap-switch data-off-color="danger" data-on-color="success">
                              <!-- <input type="checkbox" name="my-checkbox" data-bootstrap-switch data-off-color="danger" data-on-color="success"> -->
                            </td>
                            <td>
                              <input type="checkbox" name="modulos[<?= $i; ?>][w]" <?= $wCheck ?>  data-bootstrap-switch data-off-color="danger" data-on-color="success">
                            </td>
                            <td>
                              <input type="checkbox" name="modulos[<?= $i; ?>][u]" <?= $wCheck ?>  data-bootstrap-switch data-off-color="danger" data-on-color="success">
                            </td>
                            <td>
                              <input type="checkbox" name="modulos[<?= $i; ?>][d]" <?= $wCheck ?>  data-bootstrap-switch data-off-color="danger" data-on-color="success">
                            </td>
                          </tr>
                          <?php 
                                $no++;
